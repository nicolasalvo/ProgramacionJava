    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            case 2:
                ...
                try {
                    model.UserDataValidations.validatePath(ruta);
                    model.UserDataValidations.validateFileName(archivo);
                    Funciones.createFile(ruta, archivo, contenido);
                } catch (exceptions.InvalidPathException | exceptions.InvalidFileNameException e) {
